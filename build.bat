...
rem echo Building mokapot.dll
rem g++ -shared -static-libgcc -static-libstdc++ -I"C:\lua\lua-5.1\src" -I"C:\Program Files (x86)\Java\jdk1.8.0_25\include" -I"C:\Program Files (x86)\Java\jdk1.8.0_25\include\win32" -L"C:\lua" -L"C:\Program Files (x86)\Java\jdk1.8.0_25\lib" src\main\cpp\mokapot.cpp -o target\Plugins\MokaPot\mokapot.dll -llua51 -ljvm 
